...
const { ALLOWED_FILE_TYPES, MAX_FILE_SIZE, UPLOAD_PRODUCT_IMG_DIRECTORY } = require('../src/config');
...
module.exports = {uploadUserImage, uploadProductImage, fileFilter, userStorage};